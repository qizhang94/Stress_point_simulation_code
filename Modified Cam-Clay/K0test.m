...
Props = [1.0, 0.2508, 0.05387, 3.5804, 0.25]; % Material properties (v1 = 3.5804 is the value of p = 1 unit of ICL, 0.25 is the Poisson's ratio)
...
comp_incr = -5e-4; % Compression strain amount increment
...
for i = 1:1:ntolstep
    strain_iter = [0; 0; comp_incr; 0; 0; 0]; % Pure strain driven point simulation
...
lgd = legend('Simulated path', 'CSL', 'Yield surface', 'Location','best'); axis equal;
lgd.FontSize = 14;
lgd.Interpreter = 'Latex';
xlabel('$-p''$ (kPa)', 'Interpreter','latex');
ylabel('von Mises stress $q = \|\sigma_1 - \sigma_3\|$ (kPa)', 'Interpreter','latex');
