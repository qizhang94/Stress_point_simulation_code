...
Props = [1.07, 0.0026, 0, 40*pi/180]; % M, lambda, kappa, theta


% Preconsolidation pressure = 40 [MPa]
pconf0 = 40; % Initial confining pressure (isotropic) [MPa]
pc0 = -40; % [MPa]
...
% ea_data_45bed = ea_data; q_data_45ed = q_data; save("NCTournemire_simu.mat","ea_data_45bed","q_data_45ed","-append");
